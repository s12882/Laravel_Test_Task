        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-grey-mint">
                    <i class="fa fa-resp fa-2x font-grey-mint"></i>
                    <span class="caption-subject uppercase bold">Responses page</span>
                </div>
            </div>
            <div class="portlet-body">
                ...
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{route('resp.create')}}" class="btn grey-mint btn-outline">
                                    Add
...
@stop
@section('page-js')
@include('resp.partials.index-page-scripts')
@stop
